...
namespace UserModule_TEST
{
    public class UserModuleClass_TEST : SplusObject
    {
        ...
        public override object FunctionMain (  object __obj__ ) 
            ...
            try
            {
                ...
                for ( I  = __FN_FORSTART_VAL__1; (__FN_FORSTEP_VAL__1 > 0)  ? ( (I  >= __FN_FORSTART_VAL__1) && (I  <= __FN_FOREND_VAL__1) ) : ( (I  <= __FN_FORSTART_VAL__1) && (I  >= __FN_FOREND_VAL__1) ) ; I  += (ushort)__FN_FORSTEP_VAL__1) 
                    ...
                    if ( Functions.TestForTrue  ( ( Functions.BoolToInt (Mod( I , 2 ) == 0))  ) ) 
                        { 
...
public UserModuleClass_TEST ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
